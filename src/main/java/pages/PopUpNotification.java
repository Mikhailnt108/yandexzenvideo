...
public class PopUpNotification extends BasePageWebDriver {
    ...
    public void createAndPublishedPopUpNotifScreenNilPayFilm() {
        given().auth().basic("mc2soft", "wkqKy2sWwBGFDR").
                ...
                "\"body\":\"тело\",\"start_activity\":\"2021-06-01T12:56:00Z\",\"stop_activity\":\"2025-01-01T12:56:00Z\",\"notification_type\":" +
                ...
                "\"notification_duration\":{\"type\":\"date\",\"valid_until\":\"2025-01-01T12:56:00Z\",\"valid_duration\":3600},\"user_filters\":" +
                "{\"msisdn_filter\":false,\"auth_filter\":\"registered\",\"vk_only_filter\":false,\"partners\":[\"megafon_tv\"]}}").
                when().
                put("https://bmp-preprod6.megafon.tv/cms/api/v0/notification_factories/autotest1").
    ...
    public void deletePopUpNotifScreenNilPayFilm() {
        given().auth().
                ...
                delete("https://bmp-preprod6.megafon.tv/cms/api/v0/notification_factories/autotest1").
    ...
    public void createAndPublishedPopUpNotifScreenFilms() {
        given().auth().basic("mc2soft", "wkqKy2sWwBGFDR").
                ...
                "\"body\":\"тело\",\"start_activity\":\"2021-04-07T12:56:00Z\",\"stop_activity\":\"2025-01-01T12:56:00Z\",\"screen_filter\":\"mftv://menu/films\"," +
                "\"notification_type\":" +
                "\"text\",\"no_pictogram\":false,\"buttons\":[{\"text\":\"Закрыть\",\"type\":\"button_x\",\"action\":\"none\",\"accepts_offer\":false}," +
                "{\"text\":\"Купить\",\"type\":\"button_other\",\"action\":\"purchase\",\"purchase_package_id\":\"Dovod_2020\"}],\"processed_images_id\":" +
                "null,\"images\":{\"tile_notification\":" +
                ...
                "{\"msisdn_filter\":false,\"auth_filter\":\"registered\",\"vk_only_filter\":false,\"partners\":[\"megafon_tv\"]}}").
                when().
                put("https://bmp-preprod6.megafon.tv/cms/api/v0/notification_factories/autotest2").
                then().
                statusCode(200);
    }
    ...
    public void deletePopUpNotifScreenFilms() {
        given().auth().
                basic("mc2soft", "wkqKy2sWwBGFDR").when().
                delete("https://bmp-preprod6.megafon.tv/cms/api/v0/notification_factories/autotest2").
                then().statusCode(anyOf(is(200),is(204),is(404)));
    }
    ...
    public void createAndPublishedPopUpNotifScreenNilDeepLinkFilms() {
        given().auth().basic("mc2soft", "wkqKy2sWwBGFDR").
                ...
                "\"body\":\"тело\",\"start_activity\":\"2021-04-07T12:56:00Z\",\"stop_activity\":\"2025-01-01T12:56:00Z\",\"notification_type\":" +
                "\"text\",\"no_pictogram\":false,\"buttons\":[{\"text\":\"Закрыть\",\"type\":\"button_x\",\"action\":\"none\",\"accepts_offer\":false}," +
                ...
                "{\"msisdn_filter\":false,\"auth_filter\":\"registered\",\"vk_only_filter\":false,\"partners\":[\"megafon_tv\"]}}").
                when().
                put("https://bmp-preprod6.megafon.tv/cms/api/v0/notification_factories/autotest3").
                then().
                statusCode(200);
    }
    ...
    public void deletePopUpNotifScreenNilDeepLinkFilms() {
        given().auth().
                basic("mc2soft", "wkqKy2sWwBGFDR").when().
                delete("https://bmp-preprod6.megafon.tv/cms/api/v0/notification_factories/autotest3").
                then().statusCode(anyOf(is(200),is(204),is(404)));
    }
}
