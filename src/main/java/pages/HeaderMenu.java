...
public class HeaderMenu extends BasePage {
    ...
    public void inputEmail() {
        ...
        Assert.assertEquals(0, driver.findElements(By.xpath("//div[@role='dialog']//svg[@viewBox='0 0 14 14']")).size());
        writeText(By.xpath("//input[@type='email']"), "a");
        //Assert.assertEquals(1, driver.findElements(By.xpath("//svg[@viewBox='0 0 14 14']")).size());
        writeText(By.xpath("//input[@type='email']"), "email@notvalid");
        Assert.assertEquals(1, driver.findElements(By.xpath("//div[@role='dialog']//button[@type='button' and @disabled]")).size());
        writeText(By.xpath("//input[@type='email']"), "ispolnitel1mt@ya.ru");
        Assert.assertEquals(0, driver.findElements(By.xpath("//div[@role='dialog']//button[@type='button' and @disabled]")).size());
