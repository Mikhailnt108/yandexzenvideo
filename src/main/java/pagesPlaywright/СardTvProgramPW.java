...
import static base.TestBasePlaywright.browserHeadfull;
...
public class СardTvProgramPW extends BasePagePlaywright {
    ...
    public СardTvProgramPW(Page page) {
        ...
        this.page = page;
        this.pageHeadfull = pageHeadfull;
    ...
    public void checkAutoStartVideoPlayer() throws InterruptedException {
        pageHeadfull = browserHeadfull.newPage(new Browser.NewPageOptions().setViewportSize(1880,930));
        pageHeadfull.navigate("https://web-preprod5.megafon.tv/tv/tv_catalog");
        pageHeadfull.click("(//a[@class='_3qpWWwbv1F2VcSRTSjiIgS'])[3]");
        // сюда добавить флоу авторизации
        ////////////////////////////
