...
public class SerialsPagePW extends BasePagePlaywright {
    ...
    public void checkImageSerialsPageScrollForUnauthorized() throws IOException, InterruptedException {
        ...
        pagePlayer.navigate("https://web-preprod5.megafon.tv/shows");
        ...
        for (int i = 0; i < pagePlayer.querySelectorAll("//div[@class='_3H6SpMZcck2BFXiKBB5gtC _3l_eEMTBvsXXhIcEIbq6Zh']").size(); i++) {
            ...
            pagePlayer.evaluate("t => t.innerText='Название сериала'", titlePackageAll.get(i));
        ...
        pagePlayer.evaluate("t => t.innerText='Название контента'", titleBanner);
        ElementHandle stiker = pagePlayer.querySelector("(//div[@class='kjFUbLahFxqq2AjHY8j2R'])[1]");
