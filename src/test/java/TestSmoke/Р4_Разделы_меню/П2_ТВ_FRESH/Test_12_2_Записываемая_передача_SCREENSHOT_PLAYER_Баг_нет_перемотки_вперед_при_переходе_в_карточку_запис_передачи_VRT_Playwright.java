...
public class Test_12_2_Записываемая_передача_SCREENSHOT_PLAYER_Баг_нет_перемотки_вперед_при_переходе_в_карточку_запис_передачи_VRT_Playwright extends TestBasePlaywright {
