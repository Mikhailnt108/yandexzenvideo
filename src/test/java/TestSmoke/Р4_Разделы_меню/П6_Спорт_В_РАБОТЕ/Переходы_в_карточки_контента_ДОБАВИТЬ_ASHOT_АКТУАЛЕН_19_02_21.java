package TestSmoke.Р4_Разделы_меню.П6_Спорт_В_РАБОТЕ;
...
public class Переходы_в_карточки_контента_ДОБАВИТЬ_ASHOT_АКТУАЛЕН_19_02_21 extends TestBaseWebDriver {
