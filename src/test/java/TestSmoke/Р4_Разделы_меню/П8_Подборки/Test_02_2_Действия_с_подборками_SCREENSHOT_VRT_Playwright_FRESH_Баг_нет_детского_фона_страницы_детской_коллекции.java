...
public class Test_02_2_Действия_с_подборками_SCREENSHOT_VRT_Playwright_FRESH_Баг_нет_детского_фона_страницы_детской_коллекции extends TestBasePlaywright {
    ...
    public void actionsWithCollections() throws IOException, InterruptedException {
        ...
        collectionsPagePW.checkImagePageCollection();
    }
}
