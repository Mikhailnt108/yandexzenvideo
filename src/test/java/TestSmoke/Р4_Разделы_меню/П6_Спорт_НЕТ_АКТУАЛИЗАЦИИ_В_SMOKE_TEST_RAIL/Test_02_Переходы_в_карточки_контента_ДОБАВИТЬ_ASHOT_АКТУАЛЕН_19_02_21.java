package TestSmoke.Р4_Разделы_меню.П6_Спорт_НЕТ_АКТУАЛИЗАЦИИ_В_SMOKE_TEST_RAIL;
...
public class Test_02_Переходы_в_карточки_контента_ДОБАВИТЬ_ASHOT_АКТУАЛЕН_19_02_21 extends TestBaseWebDriver {
