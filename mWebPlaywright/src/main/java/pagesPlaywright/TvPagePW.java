...
//        page.click("//div[text()='Подтвердить']");
    ...
    public void chooseAvailableTvChannels() {
        ...
        Assert.assertEquals(page.querySelectorAll("//div[contains(@class,'programs')]").size(), page.querySelectorAll("._2mLz14ja1zCBwrRv-RM7lg").size());}
        ElementHandle filter = page.waitForSelector(".Ml_oz1fhp-oa2a75_b9Tp");
        System.out.println(filter.evaluate("e => window.getComputedStyle(e).color"));
//        Assert.assertEquals("bug: the color of the element is not white", filter.evaluate("e => window.getComputedStyle(e).color"), "rgb(255, 255, 255)");
        ...
        ElementHandle filter2 = page.waitForSelector(".Ml_oz1fhp-oa2a75_b9Tp");
        System.out.println(filter2.evaluate("e => window.getComputedStyle(e).color"));
//        Assert.assertEquals("bug: the color of the element is not white", filter2.evaluate("e => window.getComputedStyle(e).color"), "rgb(255, 255, 255)");
