...
public class PromoCode extends BasePageWebDriver {
    ...
    public void createAndPublishedRC() {
        ...
        given().contentType("multipart/form-data").
                ...
                when().post("https://bmp-preprod3.megafon.tv/cms/ad_campaigns/create").
    ...
    public void createAndPublishedCodeGroupAndPromoCodePackageStartSoftTnB() {
        ...
        given().auth().
                ...
                body("{\"id\":\"CG_autotest_SotTnb\",\"ad_campaign_id\":\"RC_autotest\",\"name\":\"Код-группа для автотестов Мягкий ТнБ\", " +
                        ...
                        "\"ownership_type\": \"date\"}}}").
                when().post("https://bmp-preprod3.megafon.tv/cms/ad_campaigns/RC_autotest/add_code_group").
        ...
        given().auth().
                ...
                when().post("https://bmp-preprod3.megafon.tv/cms/code_groups/CG_autotest_SotTnb/add_promocode").
    ...
    public void createAndPublishedCodeGroupAndPromoCodePackageMoreTvHardTnB() {
        ...
        given().auth().
                ...
                multiPart("partner", "default").
                multiPart("dispatch_channel", "default").
                when().post("https://bmp-preprod3.megafon.tv/cms/code_groups/CG_autotest_HardTnB/add_promocode").
                then().statusCode(anyOf(is(200),is(302),is(409)));
    }
    ...
    public void createAndPublishedCodeGroupAndPromoCodeFilmOnRentPromo() {
        ...
        given().auth().
                ...
                multiPart("partner", "default").
                multiPart("dispatch_channel", "default").
                when().post("https://bmp-preprod3.megafon.tv/cms/code_groups/СG_autotest_Film_RentPromo/add_promocode").
                then().statusCode(anyOf(is(200),is(302),is(409)));
    }
    ...
    public void createAndPublishedCodeGroupAndPromoCodeFilmOnEST() {
        ...
        given().auth().
                ...
                multiPart("partner", "default").
                multiPart("dispatch_channel", "default").
                when().post("https://bmp-preprod3.megafon.tv/cms/code_groups/СG_autotest_Film_EST/add_promocode").
                then().statusCode(anyOf(is(200),is(302),is(409)));
    }
    ...
    public void archiveCodeGroupPackageStartSoftTnB() {
        given().auth().
                basic("mc2soft", "wkqKy2sWwBGFDR").
                when().get("https://bmp-preprod3.megafon.tv/cms/code_groups/CG_autotest_SotTnb/toggle_publish").
                then().statusCode(200);
    }
    ...
    public void archiveCodeGroupPackageMoreTvHardTnB() {
        given().auth().
                basic("mc2soft", "wkqKy2sWwBGFDR").
                when().get("https://bmp-preprod3.megafon.tv/cms/code_groups/CG_autotest_HardTnB/toggle_publish").
                then().statusCode(200);
    }
    ...
    public void archiveCodeGroupFilmOnRentPromo() {
        given().auth().
                basic("mc2soft", "wkqKy2sWwBGFDR").
                when().get("https://bmp-preprod3.megafon.tv/cms/code_groups/СG_autotest_Film_RentPromo/toggle_publish").
                then().statusCode(200);
    }
    public void archiveCodeGroupFilmOnEST() {
        given().auth().
                basic("mc2soft", "wkqKy2sWwBGFDR").
                when().get("https://bmp-preprod3.megafon.tv/cms/code_groups/СG_autotest_Film_EST/toggle_publish").
                then().statusCode(200);
    }
}
