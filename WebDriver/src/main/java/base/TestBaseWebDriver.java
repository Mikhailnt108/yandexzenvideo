...
//        WebDriverRunner.setWebDriver(webDriver);
        ...
        serialsPage = new SerialsPage(webDriver);
        ...
        nilPage = new NilPage(webDriver);
        kidsPage = new KidsPage(webDriver);
        ...
        popUpNotification = new PopUpNotification(webDriver);
        promoCode = new PromoCode(webDriver);
        personalOffer = new PersonalOffer(webDriver);
