...
//        if (testRailEnabled()) { // replace with your own method of reading data from prom properties file
        ...
        final String userId = "mtabunkov@megalabs.ru";
        final String pwd = "14111987m=-=";
        final Integer projectId = 1;
        final Integer testSuiteId = 10583; // Suite ID should be unique per project
...
//            final Integer milestone = 666; // Milestone is set per each project and should reflect release version(e.g. 1.0, 666)
        ...
        final String name = "[AutoSmoke][Web] Test Run on browser Google Chrome last version, completed - ";
